...
CREATE TABLE compose (
    ...
    CONSTRAINT fk_compose_bouquet FOREIGN KEY (id_bouquet) REFERENCES bouquet(id_bouquet),
    CONSTRAINT fk_compose_produit FOREIGN KEY (id_produit) REFERENCES produit(id_produit),
